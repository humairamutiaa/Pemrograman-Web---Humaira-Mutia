...
<body style='font-family:tahoma; font-size:8pt;padding-top:50px'>
    <table style='width:660; font-size:16pt; font-family:calibri; border-collapse: collapspe;' border='0'>
        <tr>
            <td style="padding-left:80px"><img src="foto/logo86.png" width="90" height="90"></td>
            <td>
                <center>
                    <font size="6"><b>86 CAR</b></font><br>
                    <font size="3"><b>Bekasi Timur Regensi Blok O9 No 29 RT 1/ RW 8<br>Telp : 0812 3456 7890, Email : 86car@gmail.com</b>
                    </font><br>
                </center>
            </td>
        </tr>
            ...
            <tbody>
                ...
                <?php while ($detail = $ambildetail->fetch_assoc()) { ?>
                    <tr>
                        ...
                        <td align="left">Rp. <?php echo rupiah($detail['harga']); ?></td>
                        <td align="center"><?php echo $detail['jumlah']; ?></td>
                        <td style="padding:5px;margin:5px">Rp. <?php echo rupiah($detail['subharga']); ?></td>
                    </tr>
                    <?php $nomor++; ?>
                <?php } ?>
                <tr>
